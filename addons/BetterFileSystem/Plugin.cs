...
public partial class Plugin : EditorPlugin
{
    ...
    public override void _EnterTree()
    {
        ...
        firstRow.GetChild<LineEdit>(3).TextSubmitted += (_) => { GD.Print("Hello world"); CallDeferred(MethodName.FullUpdate); };
        firstRow.GetChild<LineEdit>(3).TextChanged += (_) => { GD.Print("Hello world"); CallDeferred(MethodName.FullUpdate); };
        firstRow.GetChild<LineEdit>(3).TextChangeRejected += (_) => { GD.Print("Hello world"); CallDeferred(MethodName.FullUpdate); };
