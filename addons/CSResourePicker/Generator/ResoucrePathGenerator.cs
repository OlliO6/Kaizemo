...
public class ResoucrePathGenerator : ISourceGenerator
{
    ...
    private const string RelPathToThisGenerator = @"addons\CSResourePicker\Generator\ResoucrePathGenerator.cs";
    ...
    public void Execute(GeneratorExecutionContext context)
    {
        ...
        void GenerateSource(SyntaxTree syntaxTree, ClassDeclarationSyntax @class)
        {
            ...
            context.AddSource($"{@class.Identifier}_ResourcePath.g.cs", sb.ToString());
        }
    }
